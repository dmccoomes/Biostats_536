...
**Table 3:** Odds ratios and 95% confidence intervals for the effect of x-ray exposure adjusting for year of birth using a quadratic effect modification model.
...
est_1948 <- lincom(quadintmod_2, c("xrayxray + (-16)*xraynum:yob + 36*xraynum:yob2==0"))
est_1952 <- lincom(quadintmod_2, c("xrayxray + (-12)*xraynum:yob + 4*xraynum:yob2==0"))
est_1956 <- lincom(quadintmod_2, c("xrayxray + (-8)*xraynum:yob + 4*xraynum:yob2 ==0"))
est_1960 <- lincom(quadintmod_2, c("xrayxray + (-4)*xraynum:yob + 36*xraynum:yob2 ==0"))
est_1964 <- lincom(quadintmod_2, c("xrayxray + xraynum:yob + 100*xraynum:yob2 ==0"))
